...
class ErrorHandlingLiveTest {
    ...
    @Test
    void whenRequestingFaultyEndpointAsJson_thenReceiveDefaultResponseWithConfiguredAttrs() {
    ...
    @Test
    void whenRequestingFaultyEndpointAsXml_thenReceiveXmlResponseWithConfiguredAttrs() {
    ...
    @Test
    void whenRequestingFaultyEndpointAsHtml_thenReceiveWhitelabelPageResponse() throws Exception {
        try (WebClient webClient = new WebClient()) {
            webClient.getOptions()
                    .setThrowExceptionOnFailingStatusCode(false);
            HtmlPage page = webClient.getPage(EXCEPTION_ENDPOINT);
            Assert.assertTrue(page.getBody().asNormalizedText().contains("Whitelabel Error Page"));
        }
    }
}
